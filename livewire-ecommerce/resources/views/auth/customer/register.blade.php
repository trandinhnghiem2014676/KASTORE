    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                <a href="{{url('/')}}"><i class="fi-rs-home mr-5"></i>Trang chủ</a>
                 <span></span> Đăng ký
            </div>
        </div>
    </div>
                            ...
                            <div class="login_wrap widget-taber-content background-white">
                                <div class="padding_eight_all bg-white">
                                    <div class="heading_s1">
                                        ...
                                        <p class="mb-30">Bạn đã có tài khoản chưa? <a href="{{ route('login', app()->getLocale()) }}">Đăng nhập</a></p>
                                    </div>
                                    <form method="POST" action="{{ route('register', app()->getLocale()) }}"
                                          enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <label class="form-label" for="billing_name">Tên
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="billing_surname">Họ
                                                <span class="text-danger">*</span>
                                            </label>
...
{{--                                        </div>--}}
                                        <div class="login_footer form-group mb-50">
                                            ...
                                            <a href="#"><i class="fi-rs-book-alt mr-5 text-muted"></i>Xem thêm</a>
                                        </div>
                                        <div class="login_footer form-group mb-50">
                                        ...
                                        <p class="font-xs text-muted"><strong>Lưu ý:</strong>dữ liệu cá nhân của bạn sẽ được sử dụng khi họ tương tác với trang web. </p>
                                    </form>
                                </div>
                            </div>
                        </div>
