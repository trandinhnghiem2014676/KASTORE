                            ...
                            <div class="card mb-3 mb-lg-0">
                                <form action="{{ route('addressUpdate', [app()->getLocale(),$customer->shipping_id]) }}"
                                    ...
                                    <div class="card-header">
                                        <h5 class="mb-6">Địa chỉ giao hàng</h5>
                                    </div>
                                    ...
                                    <div class="card-header"
                                        ...
                                        <h5 class="mb-5">Địa chỉ thanh toán</h5>
                                    </div>
                                    <div class="card-body contact-from-area">
                                        <div class="notranslate row">
...
{{--                                            <h4 class="title title-underline ls-25 font-weight-bold">Địa chỉ thanh toán</h4>--}}
