...
@section('body')
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            <strong>Cảnh báo!</strong> Có vấn đề với dữ liệu đã nhập.<br><br>
            <ul>
        ...
        <div class="md:grid md:grid-cols-1 md:gap-2">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Thêm sản phẩm</h3>
                </div>
            </div>
...
12 w-12 text-gray-400" stroke="currentColor" fill="none"
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            ...
                                            <p class="pl-1">hoặc kéo thả tệp</p>
                                        </div>
                                        <p class="text-xs text-gray-500">
                                            PNG, JPG, GIF không quá 10MB
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                <label for="description"
                                       class="block text-sm font-medium text-gray-700">Mô tả</label>
                                <textarea id="description" name="description" rows="3"
                                          class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md"
                                          placeholder=""></textarea>
                            </div>
{{--                            <label for="size" class="block text-sm font-medium text-gray-700">Kích cỡ</label>--}}
