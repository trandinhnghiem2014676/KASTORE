                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div class="md:col-span-1">
                            <label for="availability" style="margin-right:10px;">Ngày sản xuất </label>
                        ...
                        <div class="grid grid-cols-3 gap-6">
                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                <label for="slug" class="block text-sm font-medium text-gray-700">Giá</label>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <label for="categories[]"
                                   class="block text-sm font-medium text-gray-700">Danh mục</label>
                        ...
                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                            <a href="{{url()->previous()}}"
                               class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Quay lại
