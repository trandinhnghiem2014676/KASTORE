                         ...
                         <div class="item">
                             ...
                             <div class="img-ctn3">
                                 <div class="groups-img">
                                     <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn3/shoe12_968efbaa-1956-4621-93d2-1f1f8fdc3d11_600x.webp" ?>" alt="">
                 ...
                 <div class="row">
                     ...
                     <div class="col-4 picture-3" data-aos="zoom-out-right" data-aos-duration="1000">
                         <div class="item">
                             ...
                             <div class="img-ctn3">
                                 <div class="groups-img">
                                     <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn2/shoe_product.webp" ?>" alt="">
                             ...
                             <div class="name-shoe-ctn3">
                                 <h1> <a href="#">BOAT SHOE</a> </h1>
                                 <div class="cost-ctn3">
                                     <h2> <span>$</span> 532.00</h2>
                                 </div>
                                 <div class="icon-ctn3">
                                     <div class="icon-start">
                                         <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star">
                     ...
                     <div class="col-4 picture-3" data-aos="zoom-out-right" data-aos-duration="1000">
                         <div class="item">
                             ...
                             <div class="name-shoe-ctn3">
                                 <h1> <a href="#">BOY'S POLO SHOES</a> </h1>
                                 <div class="cost-ctn3">
                                     <h2> <span>$</span> 478.00</h2>
                                 </div>
                                 <div class="icon-ctn3">
