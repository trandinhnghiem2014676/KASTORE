                        ...
                        <div class="row">
                            ...
                            <div class="col-4 picture-3">
                                <div class="item">
                                    ...
                                    <div class="img-ctn3">
                                        <div class="groups-img">
                                            <img src="<?php echo _PATH_ROOT."/assets/img/img-header/shoe11.webp" ?>"
                                                alt="">
                                    ...
                                    <div class="name-shoe-ctn3">
                                        <h1> <a href="#">HIGH-HEELED FOOTWEAR</a> </h1>
                                        <div class="cost-ctn3">
                                            <h2>$478.00</h2>
                                        </div>
                                        <div class="icon-ctn3">
                            ...
                            <div class="col-4 picture-3">
                                <div class="item">
                                    ...
                                    <div class="img-ctn3">
                                        <div class="groups-img">
                                            <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn5/shoe20_600x.webp" ?>"
                                                alt="">
                        ...
                        <div class="row">
                            <div class="col-4 picture-3">
                                <div class="item">
                                    ...
                                    <div class="name-shoe-ctn3">
                                        <h1> <a href="#">JUNIORS' ATHLETIC SHOES</a> </h1>
                                        <div class="cost-ctn3">
                                            <h2>$498.00</h2>
                                        </div>
                                        <div class="icon-ctn3">
                            ...
                            <div class="col-4 picture-3">
                                <div class="item">
                                    ...
                                    <div class="img-ctn3">
                                        <div class="groups-img">
                                            <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn2/shoe_product.webp" ?>"
                                                alt="">
                                            <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn2/collection3_large.webp" ?>" alt="">
                                        </div>
                                        <div class="icon-ctn3">
                                            <a href=""><i class="fa-solid fa-message"></i></a>
                                            <a href=""><i class="fa-brands fa-gratipay"></i></a>
                                    ...
                                    <div class="name-shoe-ctn3">
                                        <h1> <a href="#">VANS BLACK CANVAS SHOES</a> </h1>
                                        <div class="cost-ctn3">
                                            <h2>$532.00</h2>
                                        </div>
                                        <div class="icon-ctn3">
                            ...
                            <div class="col-4 picture-3">
                                <div class="item">
                                    ...
                                    <div class="img-ctn3">
                                        <div class="groups-img">
                                            <img src="<?php echo _PATH_ROOT."/assets/img/img-header/shoe21.webp" ?>" alt="">
                                            <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn2/shoe23_5444b0e6-72c7-450c-aab6-081a70660dcd_720x.webp" ?>" alt="">
                                        </div>
                                        <div class="icon-ctn3">
                                            <a href=""><i class="fa-solid fa-message"></i></a>
                                            <a href=""><i class="fa-brands fa-gratipay"></i></a>
                                    ...
                                    <div class="name-shoe-ctn3">
                                        <h1> <a href="#">NEW MEN'S RUNNING SHOES</a> </h1>
                                        <div class="cost-ctn3">
                                            <h2>$478.00</h2>
                                        </div>
                                        <div class="icon-ctn3">
                ...
                <div class="col-3" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                    <div class="sidebar-product">
                        <div class="recent-product">
                            ...
                            <p>Hot Deals</p>
                            <div class="img-ctn3">
                                <img src="<?php echo _PATH_ROOT."/assets/img/slide-header/breadcrumb-4.webp" ?>" alt="">
                            </div>                           
