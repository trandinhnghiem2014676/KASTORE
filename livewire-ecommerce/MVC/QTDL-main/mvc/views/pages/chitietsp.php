<div class="slide-header">
            <div class="contain-slide">
                <p>PRODUCT</p>
                <ul>
                    <li><a href="<?php echo _WEB_ROOT.'/ueser/trangchu' ?>">All</a> </li>
                    <li>/</li>
                    <li>Adidas Kampung</li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn3/shoe12_968efbaa-1956-4621-93d2-1f1f8fdc3d11_600x.webp" ?>" alt="" class="ctn__img">
                </div>
                <div class="col-md-6">
                    <h3 class="title-heading">Adidas Kampung</h3>
                    <div class="container-info">
                        ...
                        <div class="info-detail">
                            ...
                            <div class="info-border">
                                <span><img src="<?php echo _PATH_ROOT."/assets/img/img-ctn3/shoe15_720x.webp" ?>" alt=""></span>
                                <span><img src="<?php echo _PATH_ROOT."/assets/img/img-ctn5/shoe-red.webp" ?>" alt=""></span>
                                <span><img src="<?php echo _PATH_ROOT."/assets/img/img-ctn5/shoe20_600x.webp" ?>" alt=""></span>
                          </div>
                        ...
                        <div class="btn-detail">
                            <button><a href="giohang.html"><span>ADD TO WISHLIST</span></a></button>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="item">
                            ...
                            <div class="img-ctn3">
                                <div class="groups-img">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn3/shoe12_968efbaa-1956-4621-93d2-1f1f8fdc3d11_600x.webp" ?>"
                                        alt="">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-header/shoe26_de67b47c-8d95-481f-aa85-268cdc309e4e.webp" ?>"
                                        alt="">
                                </div>
                                <div class="icon-ctn3">
                    ...
                    <div class="col-3 picture-3" data-aos="zoom-out-right" data-aos-duration= "1000">
                        <div class="item">
                            ...
                            <div class="img-ctn3">
                                <div class="groups-img">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn2/shoeyelow.webp" ?>" alt="">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn2/shoe2_720x.webp" ?>" alt="">
                                </div>
                                <div class="icon-ctn3">
                                    <a href=""><i class="fa-solid fa-message"></i></a>
                                    <a href=""><i class="fa-brands fa-gratipay"></i></a>
                    ...
                    <div class="col-3 picture-3" data-aos="zoom-out-right" data-aos-duration= "1000">
                        <div class="item">
                            ...
                            <div class="img-ctn3">
                                <div class="groups-img">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-ctn5/shoe20_600x.webp" ?>" alt="">
                        ...
                        <div class="item">
                            ...
                            <div class="img-ctn3">
                                <div class="groups-img">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-header/shoe26_de67b47c-8d95-481f-aa85-268cdc309e4e.webp" ?>"
                                        alt="">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-header/shoe22_48464579-a7fe-40ba-ad66-8c6aa7ef2bb1.webp" ?>"
                                        alt="">
                                </div>
                                <div class="icon-ctn3">
                                    <a href=""><i class="fa-solid fa-message"></i></a>
