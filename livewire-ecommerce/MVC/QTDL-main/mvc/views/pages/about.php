<div class="slide-header">
                ...
                <div class="row">
                    <div class="col-6" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                        <div class="dt-sc-img-section">
                            <div class="dt-sc-img">
                                <div class="img-about">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-about/about001_600x.webp" ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                        <div class="dt-sc-img-section-2">
                            <div class="dt-sc-img-2">
                                <div class="img-about">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-about/about002_600x.webp" ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="dt-sc-img-section-3">
                            <div class="dt-sc-img-3">
                                <div class="img-about">
                                    <img src="<?php echo _PATH_ROOT."/assets/img/img-about/about003_600x.webp" ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container" >
            <div class="dc-st-footer" data-aos="zoom-in-down" data-aos-duration="1000">
                ...
                <img src="<?php echo _PATH_ROOT."/assets/img/img-about/shoe-imh_800x.webp" ?>" alt="">
            </div>
        </div>