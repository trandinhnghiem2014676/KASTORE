                ...
                <div class="col-9">
                    <div class="container-123">
                        ...
                        <div class="container-1 img-blog">
                            <img src="<?php echo _PATH_ROOT."/assets/img/img-Pages-blog/anh 1.webp" ?>" alt="">
                        ...
                        <div class="container-1 img-blog">
                            <img src="<?php echo _PATH_ROOT."/assets/img/img-Pages-blog/anh-2.webp" ?>" alt="">
                            <div class="dt-sc-blog-content">
                                <div class="list-icon-blog">
                                    <ul>
                                        <li><i class="fa-solid fa-circle-user"></i>
                        ...
                        <div class="container-1 img-blog">
                            <img src="<?php echo _PATH_ROOT."/assets/img/img-Pages-blog/anh-3.webp" ?>" alt="">
                            <div class="dt-sc-blog-content">
                                <div class="list-icon-blog">
                                    <ul>
                                        <li><i class="fa-solid fa-circle-user"></i>
